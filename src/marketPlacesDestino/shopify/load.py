...
def load_sku(page_shopi,amazonDatSku,productDataSht,configData):
    ...
    page_shopi.wait_for_selector(pshopy.cajaPrecioComparacion.selector)
    page_shopi.query_selector(pshopy.cajaPrecioComparacion.selector).fill(productDataSht['PrecioListaShopify'])
    page_shopi.wait_for_selector(pshopy.cajaStock.selector)
    ...
    page_shopi.query_selector(pshopy.cajaPesoDelProducto.selector).click()
