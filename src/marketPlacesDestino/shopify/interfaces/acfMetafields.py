...
listaProductoParaEditar=localizador("lista obtenida de poner el nombre del producto para ubicar el cual se añadirán las espcficaciones","ul[class='Polaris-ResourceList']","css")
