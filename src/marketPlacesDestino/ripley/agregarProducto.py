...
#PARA AGREGAR UN PRODUCTO NUEVO - PREVIA
...
#AGREGAR UN PRODUCTO NUEVO - 4 PARTES
...
desplegableMarca=localizador("recuadro para ingresar Marca del Producto","div[id='productCreationFormField-1104'] b","css") 
...
botonImagenSeis=localizador("para ingresar link de imagen seis","input[id='productAndOffersCommand-attributeValuesFormCommand-4139']","css")
...
cajaPesoKg=localizador("para ingresar el Peso del producto en Kg","input[id='productAndOffersCommand-attributeValuesFormCommand-287510']","css")
cajaUpc=localizador("para ingesar el UPC","input[id='productAndOffersCommand-attributeValuesFormCommand-222409']","css") #ni idea que es esto
...
cajaCantidadOferta=localizador("recuadro para llenar cantidad disponible del producto","input[id='quantity']","css")
...
#no se ha probado la creación de un producto, por lo cual el último boton para finalizar el proceso no se ha ubicado