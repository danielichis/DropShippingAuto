...
cookies = {
    ...
    'NSESSIONID_project_session': 's%3AS5RMjEHoma8YI6xHogKMRNUMsBCCib3I.S%2BOHDjNEMqKdMiRPvRJnKb15qT15dKKxBKPu8yfPcTk',
...
headers = {
    ...
    'traceparent': '00-3ed7143bae6f334cea4996cd34f271dc-c4d1633e3c9cecea-01',
    'tracestate': '1709707@nr=0-1-989586-1834935377-c4d1633e3c9cecea----1726359079708',
...
#data = '{"method":"POST","path":"list","body":{"output":{}},"headers":{},"params":{"isWebview":false,"domain":"www.mercadolibre.com.pe"},"queryParams":{"isWebview":false,"domain":"www.mercadolibre.com.pe"}}'
#response = requests.put(
#    'https://www.mercadolibre.com.pe/publicar/omni/api/event-request',
#    cookies=cookies,
#    headers=headers,
