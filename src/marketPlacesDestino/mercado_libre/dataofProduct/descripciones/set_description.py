...
headers = {
    ...
    'dpr': '1',
    'ect': '4g',
    'newrelic': 'eyJ2IjpbMCwxXSwiZCI6eyJ0eSI6IkJyb3dzZXIiLCJhYyI6Ijk4OTU4NiIsImFwIjoiMTgzNDkzNTM3NyIsImlkIjoiN2E0ZWIyN2IzMDMzMWVjOSIsInRyIjoiNjMyMDYxMGNkNzNhNmEwYmZiNjZjMzhlYzM1NmI1OWEiLCJ0aSI6MTcyNjM2NDM5MTg1OSwidGsiOiIxNzA5NzA3In19',
    ...
    'traceparent': '00-6320610cd73a6a0bfb66c38ec356b59a-7a4eb27b30331ec9-01',
    'tracestate': '1709707@nr=0-1-989586-1834935377-7a4eb27b30331ec9----1726364391859',
...
json_data = {
    'method': 'PATCH',
    'path': 'list/139265276-list_omnichannel-e48e07b44a68/item_data_form/description-default',
    'loadingEvents': [],
    'errorEvents': [],
    'queryParams': {
        'isWebview': False,
    ...
    'body': {
        'output': {
            'value': {
                'plain_text': 'reloj para ajedrez de competencia',
            },
        },
    },
    'params': {
...
#data = '{"method":"PATCH","path":"list/139265276-list_omnichannel-e48e07b44a68/item_data_form/description-default","loadingEvents":[],"errorEvents":[],"queryParams":{"isWebview":false,"domain":"www.mercadolibre.com.pe","formId":"item_data_form"},"pathParams":[],"bodyParams":[],"headers":{},"body":{"output":{"value":{"plain_text":"reloj para ajedrez de competencia"}}},"params":{"isWebview":false,"domain":"www.mercadolibre.com.pe","formId":"item_data_form"}}'
#response = requests.put(
#    'https://www.mercadolibre.com.pe/publicar/omni/api/event-request',
#    cookies=cookies,
#    headers=headers,
