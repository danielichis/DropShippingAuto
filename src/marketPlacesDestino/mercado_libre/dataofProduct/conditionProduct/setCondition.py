...
headers = {
    ...
    'dpr': '1',
    'ect': '4g',
    'newrelic': 'eyJ2IjpbMCwxXSwiZCI6eyJ0eSI6IkJyb3dzZXIiLCJhYyI6Ijk4OTU4NiIsImFwIjoiMTgzNDkzNTM3NyIsImlkIjoiMjQzYTA5OTBlYTM2M2QyNSIsInRyIjoiNWZhZWNmOTQ0OWQxYWZmMTBlMWY2ZDM5NjEyN2E1ODUiLCJ0aSI6MTcyNjM2MjIwMjA0NCwidGsiOiIxNzA5NzA3In19',
    ...
    'traceparent': '00-5faecf9449d1aff10e1f6d396127a585-243a0990ea363d25-01',
    'tracestate': '1709707@nr=0-1-989586-1834935377-243a0990ea363d25----1726362202044',
...
json_data = {
    'method': 'PATCH',
    'path': 'list/139265276-list_omnichannel-e48e07b44a68/item_data_form/itemcondition-default',
    'loadingEvents': [],
    'errorEvents': [],
    'queryParams': {
        'isWebview': False,
...
#data = '{"method":"PATCH","path":"list/139265276-list_omnichannel-e48e07b44a68/item_data_form/itemcondition-default","loadingEvents":[],"errorEvents":[],"queryParams":{"isWebview":false,"domain":"www.mercadolibre.com.pe","formId":"item_data_form"},"pathParams":[],"bodyParams":[],"headers":{},"body":{"output":{"value":{"selectedCondition":"new","monoTaxPayerCheck":false}}},"params":{"isWebview":false,"domain":"www.mercadolibre.com.pe","formId":"item_data_form"}}'
#response = requests.put(
#    'https://www.mercadolibre.com.pe/publicar/omni/api/event-request',
#    cookies=cookies,
#    headers=headers,
