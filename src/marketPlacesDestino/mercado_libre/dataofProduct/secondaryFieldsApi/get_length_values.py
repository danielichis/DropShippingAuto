...
headers = {
    ...
    'dpr': '1',
    'ect': '4g',
    'newrelic': 'eyJ2IjpbMCwxXSwiZCI6eyJ0eSI6IkJyb3dzZXIiLCJhYyI6Ijk4OTU4NiIsImFwIjoiMTgzNDkzNTM3NyIsImlkIjoiOThkZWViY2ViMDQ5MzI1YSIsInRyIjoiNDIwZDcxYzUwMzQ0OWM4ZTYzZjllMmFlZGM0M2FjOWIiLCJ0aSI6MTcyNjM2MzU5MDgwNiwidGsiOiIxNzA5NzA3In19',
    ...
    'traceparent': '00-420d71c503449c8e63f9e2aedc43ac9b-98deebceb049325a-01',
    'tracestate': '1709707@nr=0-1-989586-1834935377-98deebceb049325a----1726363590806',
...
#data = '{"method":"POST","path":"list/api/techspecs/top_values/139265276-list_omnichannel-e48e07b44a68","loadingEvents":[],"errorEvents":[],"queryParams":{"isWebview":false,"domain":"www.mercadolibre.com.pe","formId":"item_data_form"},"pathParams":[],"bodyParams":[],"headers":{},"body":{"domainId":"MPE-CHESS_CLOCKS","requestedAttributeId":"LENGTH","knownAttributes":[{"id":"BRAND","valueId":"276243","valueName":"Genérica"},{"id":"MODEL","valueId":"14416329","valueName":"Generic"}],"output":{}},"params":{"isWebview":false,"domain":"www.mercadolibre.com.pe","formId":"item_data_form"}}'.encode()
#response = requests.put(
#    'https://www.mercadolibre.com.pe/publicar/omni/api/event-request',
#    cookies=cookies,
#    headers=headers,
