...
headers = {
    ...
    'dpr': '1',
    'ect': '4g',
    'newrelic': 'eyJ2IjpbMCwxXSwiZCI6eyJ0eSI6IkJyb3dzZXIiLCJhYyI6Ijk4OTU4NiIsImFwIjoiMTgzNDkzNTM3NyIsImlkIjoiNDg5MjMxOGJkZDgyNzk5YyIsInRyIjoiZTFlMWE5NGEzMDQ4MzBiN2M1MmQyZTc2YjZhMGQ3MmIiLCJ0aSI6MTcyNjM2MTg4Nzc2NCwidGsiOiIxNzA5NzA3In19',
    ...
    'traceparent': '00-e1e1a94a304830b7c52d2e76b6a0d72b-4892318bdd82799c-01',
    'tracestate': '1709707@nr=0-1-989586-1834935377-4892318bdd82799c----1726361887764',
...
json_data = {
    'method': 'PATCH',
    'path': 'list/139265276-list_omnichannel-e48e07b44a68/item_data_form/techspecs-primary',
    'loadingEvents': [],
    'errorEvents': [],
    'queryParams': {
        'isWebview': False,
...
#data = '{"method":"PATCH","path":"list/139265276-list_omnichannel-e48e07b44a68/item_data_form/techspecs-primary","loadingEvents":[],"errorEvents":[],"queryParams":{"isWebview":false,"domain":"www.mercadolibre.com.pe","formId":"item_data_form"},"pathParams":[],"bodyParams":[],"headers":{},"body":{"output":{"value":[{"id":"MODEL","value_id":"14416329","value_name":"Generic"},{"id":"BRAND","value_id":"276243","value_name":"Genérica"}]}},"params":{"isWebview":false,"domain":"www.mercadolibre.com.pe","formId":"item_data_form"}}'.encode()
#response = requests.put(
#    'https://www.mercadolibre.com.pe/publicar/omni/api/event-request',
#    cookies=cookies,
#    headers=headers,
