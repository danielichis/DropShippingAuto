...
headers = {
    ...
    'dpr': '1',
    'ect': '4g',
    'newrelic': 'eyJ2IjpbMCwxXSwiZCI6eyJ0eSI6IkJyb3dzZXIiLCJhYyI6Ijk4OTU4NiIsImFwIjoiMTgzNDkzNTM3NyIsImlkIjoiNWJhMjdiMGY0MGQzZDQwNCIsInRyIjoiNzEzZjVhYTAyZjkzNDVjNTAxZGFlMDI5ZTI5MGY3YmQiLCJ0aSI6MTcyNjM2Mjc3OTc0NSwidGsiOiIxNzA5NzA3In19',
    ...
    'traceparent': '00-713f5aa02f9345c501dae029e290f7bd-5ba27b0f40d3d404-01',
    'tracestate': '1709707@nr=0-1-989586-1834935377-5ba27b0f40d3d404----1726362779745',
...
json_data = {
    'method': 'PATCH',
    'path': 'list/139265276-list_omnichannel-e48e07b44a68/item_data_form/variations-default',
    'loadingEvents': [],
    'errorEvents': [],
    'queryParams': {
        'isWebview': False,
    ...
    'body': {
        'output': {
            'value': [
                {
                    'id': '58ab5d51-aeba-47dc-8769-e57228a19c2d',
                    'scenarios': [
                        'core',
                    ],
                    'isMain': True,
                    ...
                    'pictures': [
                        {
                            'id': '878979-MPE79025434924_092024',
                            'maxSize': '1000x1000',
                            'url': 'https://http2.mlstatic.com/D_NQ_NP_878979-MPE79025434924_092024-F.jpg',
                            'secureUrl': 'https://http2.mlstatic.com/D_NQ_NP_878979-MPE79025434924_092024-F.jpg',
                            'size': '1000x1000',
                            'hasModeration': False,
                            'name': '878979-MPE79025434924_092024',
                        },
                    ],
                    ...
                    'otherAttributes': {
                        ...
                        'sellerSku': {
                            'id': 'SELLER_SKU',
                            'name': 'Código de identificación (SKU)',
                            'value': '',
                            'hex': '',
                            'notApply': False,
                        },
                    ...
                    'upMatching': False,
                    'upOtherMatching': False,
                    'fullFlexSellingCoachData': None,
                },
            ],
        },
    },
