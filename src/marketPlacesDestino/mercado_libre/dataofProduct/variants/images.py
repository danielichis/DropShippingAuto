...
headers = {
    ...
    'content-type': 'multipart/form-data; boundary=----WebKitFormBoundaryhRuWCOGB7dmqaVYW',
    ...
    'dpr': '1',
    'ect': '4g',
    'newrelic': 'eyJ2IjpbMCwxXSwiZCI6eyJ0eSI6IkJyb3dzZXIiLCJhYyI6Ijk4OTU4NiIsImFwIjoiMTgzNDkzNTM3NyIsImlkIjoiNjZiZjA1MTg5MzlhOTU4MSIsInRyIjoiZDZkM2I2ZDgwNmE4YWQyYWM2YjQ5NjMwZGRmZWZmNDQiLCJ0aSI6MTcyNjM2MjQ3NzQwNSwidGsiOiIxNzA5NzA3In19',
    ...
    'traceparent': '00-d6d3b6d806a8ad2ac6b49630ddfeff44-66bf0518939a9581-01',
    'tracestate': '1709707@nr=0-1-989586-1834935377-66bf0518939a9581----1726362477405',
...
files = {
    'name': (None, 'resizedImg_1000x1000_2.jpg'),
    'file': ('resizedImg_1000x1000_2.jpg', '', 'image/jpeg'),
}

response = requests.post(
    'https://www.mercadolibre.com.pe/publicar/omni/api/pictures',
    cookies=cookies,
    headers=headers,
    files=files,
)
