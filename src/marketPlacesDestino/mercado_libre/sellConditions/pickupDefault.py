...
headers = {
    ...
    'dpr': '1',
    'ect': '4g',
    'newrelic': 'eyJ2IjpbMCwxXSwiZCI6eyJ0eSI6IkJyb3dzZXIiLCJhYyI6Ijk4OTU4NiIsImFwIjoiMTgzNDkzNTM3NyIsImlkIjoiMTIzMWUxNmY4ZjhlYmI5YyIsInRyIjoiOTBhNmQ5ZDY1MjUwMTE0NmVmNWNmMDM4OWQwMDg1NzIiLCJ0aSI6MTcyNjM2NTkxNzQ1MCwidGsiOiIxNzA5NzA3In19',
    ...
    'traceparent': '00-90a6d9d652501146ef5cf0389d008572-1231e16f8f8ebb9c-01',
    'tracestate': '1709707@nr=0-1-989586-1834935377-1231e16f8f8ebb9c----1726365917450',
...
json_data = {
    'method': 'PATCH',
    'path': 'list/139265276-list_omnichannel-e48e07b44a68/sales_condition_form/localpickup-default',
    'loadingEvents': [],
    'errorEvents': [],
    'queryParams': {
        'isWebview': False,
...
#data = '{"method":"PATCH","path":"list/139265276-list_omnichannel-e48e07b44a68/sales_condition_form/localpickup-default","loadingEvents":[],"errorEvents":[],"queryParams":{"isWebview":false,"domain":"www.mercadolibre.com.pe","formId":"sales_condition_form"},"pathParams":[],"bodyParams":[],"headers":{},"body":{"output":{"value":true}},"params":{"isWebview":false,"domain":"www.mercadolibre.com.pe","formId":"sales_condition_form"}}'
#response = requests.put(
#    'https://www.mercadolibre.com.pe/publicar/omni/api/event-request',
#    cookies=cookies,
#    headers=headers,
