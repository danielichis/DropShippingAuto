...
headers = {
    ...
    'dpr': '1',
    'ect': '4g',
    'newrelic': 'eyJ2IjpbMCwxXSwiZCI6eyJ0eSI6IkJyb3dzZXIiLCJhYyI6Ijk4OTU4NiIsImFwIjoiMTgzNDkzNTM3NyIsImlkIjoiMTVkYTViOTRkZGE5MjJiMSIsInRyIjoiMzdiYTNlOWQ3MTEzMWFmZTllOGZkMjgwZWI3MTAzMDUiLCJ0aSI6MTcyNjM2NjAxMjUzOSwidGsiOiIxNzA5NzA3In19',
    ...
    'traceparent': '00-37ba3e9d71131afe9e8fd280eb710305-15da5b94dda922b1-01',
    'tracestate': '1709707@nr=0-1-989586-1834935377-15da5b94dda922b1----1726366012539',
...
json_data = {
    'method': 'PATCH',
    'path': 'list/139265276-list_omnichannel-e48e07b44a68/sales_condition_form/warranty_default',
    'loadingEvents': [],
    'errorEvents': [],
    'queryParams': {
        'isWebview': False,
...
#data = '{"method":"PATCH","path":"list/139265276-list_omnichannel-e48e07b44a68/sales_condition_form/warranty_default","loadingEvents":[],"errorEvents":[],"queryParams":{"isWebview":false,"domain":"www.mercadolibre.com.pe","formId":"sales_condition_form"},"pathParams":[],"bodyParams":[],"headers":{},"body":{"output":{"value":{"id":"2230279","description":"Garantía de fábrica","active":true,"currentWarranty":true,"time":{"description":"99 Días","name":"Tiempo de garantía","placeholder":"1","types":[{"title":"Días","key":"days"},{"title":"Meses","key":"months"},{"title":"Años","key":"years"}],"currentType":"Días","value":"99","keyCurrentType":"days"},"isValid":true}}},"params":{"isWebview":false,"domain":"www.mercadolibre.com.pe","formId":"sales_condition_form"}}'.encode()
#response = requests.put(
#    'https://www.mercadolibre.com.pe/publicar/omni/api/event-request',
#    cookies=cookies,
#    headers=headers,
