...
headers = {
    ...
    'dpr': '1',
    'ect': '4g',
    'newrelic': 'eyJ2IjpbMCwxXSwiZCI6eyJ0eSI6IkJyb3dzZXIiLCJhYyI6Ijk4OTU4NiIsImFwIjoiMTgzNDkzNTM3NyIsImlkIjoiN2ZhNWJkZGZjZDkxYjYwYSIsInRyIjoiZjcwNDc2ODg5YTE4NzBiZGNjZDhhZjUyOTZjYjA5MTQiLCJ0aSI6MTcyNjM2NTMxMDY4MiwidGsiOiIxNzA5NzA3In19',
    ...
    'traceparent': '00-f70476889a1870bdccd8af5296cb0914-7fa5bddfcd91b60a-01',
    'tracestate': '1709707@nr=0-1-989586-1834935377-7fa5bddfcd91b60a----1726365310682',
...
json_data = {
    'method': 'PATCH',
    'path': 'list/139265276-list_omnichannel-e48e07b44a68/sales_condition_form/price-default',
    'loadingEvents': [],
    'errorEvents': [],
    'queryParams': {
        'isWebview': False,
...
#data = '{"method":"PATCH","path":"list/139265276-list_omnichannel-e48e07b44a68/sales_condition_form/price-default","loadingEvents":[],"errorEvents":[],"queryParams":{"isWebview":false,"domain":"www.mercadolibre.com.pe","formId":"sales_condition_form"},"pathParams":[],"bodyParams":[],"headers":{},"origin":"price_domain","body":{"output":{"value":{"marketplace":{"currency":"USD","price":9999}},"isSync":false}},"params":{"isWebview":false,"domain":"www.mercadolibre.com.pe","formId":"sales_condition_form"}}'
#response = requests.put(
#    'https://www.mercadolibre.com.pe/publicar/omni/api/event-request',
#    cookies=cookies,
#    headers=headers,
