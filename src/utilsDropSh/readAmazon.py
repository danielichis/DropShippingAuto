...
def get_product_in_amazon_carpet_parsed(product_sku):
    ...
    #print(get_element_with_more_fields(list_descripciones))
    #dataAmazon["descripciones"]=ast.literal_eval(dinamic_two_systems_description(str(get_element_with_more_fields(list_descripciones))))
